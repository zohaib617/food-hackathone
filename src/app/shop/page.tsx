...
export default function Shop(){
    ...
    return(
        ...
        <a href="/shop-details" ><img src="/mask1.png" alt="food" /></a>
        ...
        <div className="transfrom hover:scale-110 transition duration-500 ease-out">
        <a href="/shop-details" ><img src="/mask3.png" alt="food" /></a>
        ...
        <div className="transfrom hover:scale-110 transition duration-500 ease-out" >
        <a href="/shop-details" ><img src="/mask2.png" alt="food" /></a>
        ...
        <div className="transfrom hover:scale-110 transition duration-500 ease-out">
        <a href="/shop-details" ><img src="/mask4.png" alt="food" /></a>
        ...
        <div className="transfrom hover:scale-110 transition duration-500 ease-out">
        <a href="/shop-details" ><img src="/mask5.png" alt="food" /></a>
        ...
        <div className="transfrom hover:scale-110 transition duration-500 ease-out">
        <a href="/shop-details" ><img src="/mask6.png" alt="food" /></a>
        ...
        <div className="transfrom hover:scale-110 transition duration-500 ease-out">
        <a href="/shop-details" ><img src="/mask7.png" alt="food" /></a>
        ...
        <div className="transfrom hover:scale-110 transition duration-500 ease-out">
        <a href="/shop-details" ><img src="/mask8.png" alt="food" /></a>
        ...
        <div className="transfrom hover:scale-110 transition duration-500 ease-out"
        ><a href="/shop-details" ><img src="/mask9.png" alt="food"  /></a>
