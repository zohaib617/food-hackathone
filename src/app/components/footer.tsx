    ...
    return(
        ...
        <section className=" flex justify-center w-full h-auto  lg:w-[1920px] lg:h-[700px] mt-16 lg:mt-24" >
            ...
            <div className=" grid grid-cols-1 md:grid-cols-2  gap-4 p-8  lg:flex justify-between  mt-12" >
                <div >
                    ...
                    <div className="flex mt-10 ">
                        <img src="/image/Watch.png" alt="" className="w-[78px] h-[72px]" />
            ...
            <div className="w-[273px]" >
                ...
                <div>
                    <img src="/image/comp1.png" alt="compo" className="mt-5 p-2 transform hover:scale-110 transition duration-500 ease-in-out"  />
                    <img src="/image/comp2.png" alt="compo"className="p-2 transform hover:scale-110 transition duration-500 ease-in-out" />
                    <img src="/image/comp3.png" alt="compo"className="p-2 transform hover:scale-110 transition duration-500 ease-in-out" />
                </div>
            </div>
                ...
                <div className=" flex justify-center items-center w-full h-auto lg:w-[1920px] lg:h-[99px]  bg-[#4F4F4F]"  >
                    ...
                    <div><img src="/image/social.png" alt="" className=" ml-12 lg:m-l0 p-4 lg:p-0" /></div>
                    </div>
                </div>
                </>
    )
